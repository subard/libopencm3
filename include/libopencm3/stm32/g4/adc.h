...
#define ADC5_ISR		ADC_ISR(ADC5_BASE)
...
#define ADC5_IER		ADC_IER(ADC5_BASE)
...
#define ADC5_CR			ADC_CR(ADC5_BASE)

/* TODO: The align bit in this register is incorrect for adc_common_v2 */
...
#define ADC5_CFGR1		ADC_CFGR1(ADC5_BASE)
...
#define ADC5_CFGR		ADC_CFGR1(ADC5_BASE)
...
#define ADC5_SMPR1		ADC_SMPR1(ADC5_BASE)
...
#define ADC5_SMPR2		ADC_SMPR2(ADC5_BASE)
...
#define ADC5_TR1		ADC_TR1(ADC5_BASE)
...
#define ADC5_TR2		ADC_TR2(ADC5_BASE)
...
#define ADC5_TR3		ADC_TR3(ADC5_BASE)
...
#define ADC5_SQR1		ADC_SQR1(ADC5_BASE)
...
#define ADC5_SQR2		ADC_SQR2(ADC5_BASE)
...
#define ADC5_SQR3		ADC_SQR3(ADC5_BASE)
...
#define ADC5_SQR4		ADC_SQR4(ADC5_BASE)
...
#define ADC5_DR			ADC_DR(ADC5_BASE)
...
#define ADC5_JSQR		ADC_JSQR(ADC5_BASE)
...
#define ADC5_OFR1		ADC_OFR1(ADC5_BASE)
...
#define ADC5_OFR2		ADC_OFR2(ADC5_BASE)
...
#define ADC5_OFR3		ADC_OFR3(ADC5_BASE)
...
#define ADC5_OFR4		ADC_OFR4(ADC5_BASE)
...
#define ADC5_JDR1		ADC_JDR1(ADC5_BASE)
...
#define ADC5_JDR2		ADC_JDR2(ADC5_BASE)
...
#define ADC5_JDR3		ADC_JDR3(ADC5_BASE)
...
#define ADC5_JDR4		ADC_JDR4(ADC5_BASE)
...
#define ADC5_AWD2CR		ADC_AWD2CR(ADC5_BASE)
...
#define ADC5_AWD3CR		ADC_AWD3CR(ADC5_BASE)
...
#define ADC5_DIFSEL		ADC_DIFSEL(ADC5_BASE)
...
#define ADC5_CALFACT		ADC_CALFACT(ADC5_BASE)

#define ADC12_CSR			ADC_CSR(ADC1)
#define ADC12_CCR			ADC_CCR(ADC1)
#define ADC12_CDR			ADC_CDR(ADC1)
#define ADC345_CSR			ADC_CSR(ADC3)
#define ADC345_CCR			ADC_CCR(ADC3)
#define ADC345_CDR			ADC_CDR(ADC3)
...
/* Only for ADC_SMPR1*/
#define ADC_SMPR_SMP_PLUSONE		0x80000000
...
#define ADC_JSQR_JEXTSEL_EVENT_0	(0x00 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_1	(0x01 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_2	(0x02 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_3	(0x03 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_4	(0x04 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_5	(0x05 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_6	(0x06 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_7	(0x07 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_8	(0x08 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_9	(0x09 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_10	(0x0A << 2)
#define ADC_JSQR_JEXTSEL_EVENT_11	(0x0B << 2)
#define ADC_JSQR_JEXTSEL_EVENT_12	(0x0C << 2)
#define ADC_JSQR_JEXTSEL_EVENT_13	(0x0D << 2)
#define ADC_JSQR_JEXTSEL_EVENT_14	(0x0E << 2)
#define ADC_JSQR_JEXTSEL_EVENT_15	(0x0F << 2)
#define ADC_JSQR_JEXTSEL_EVENT_16	(0x10 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_17	(0x11 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_18	(0x12 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_19	(0x13 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_20	(0x14 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_21	(0x15 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_22	(0x16 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_23	(0x17 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_24	(0x18 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_25	(0x19 << 2)
#define ADC_JSQR_JEXTSEL_EVENT_26	(0x1A << 2)
#define ADC_JSQR_JEXTSEL_EVENT_27	(0x1B << 2)
#define ADC_JSQR_JEXTSEL_EVENT_28	(0x1C << 2)
#define ADC_JSQR_JEXTSEL_EVENT_29	(0x1D << 2)
#define ADC_JSQR_JEXTSEL_EVENT_30	(0x1E << 2)
#define ADC_JSQR_JEXTSEL_EVENT_31	(0x1F << 2)
...
/* VBATEN: VBAT enable */
#define ADC_CCR_VBATSEL			(1 << 24)
//#define ADC_CCR_VBATEN			ADC_CCR_VBATSEL

/* TSEN: Temperature sensor enable */
#define ADC_CCR_VSENSESEL		(1 << 23)
